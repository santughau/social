       ...
       <div class="row" style="margin-top:-20px;">
           ...
           <div class="row " >
               <div class="col-md-12" style="margin-top:-25px;background-color:white; height:500px;">
                   <div class="container-fluid">
                        <div class="row" >
                        <h3 class="text-center text-primary">My All Messages</h3>
                        <table class="table table-striped table-bordered table-condensed table-responsive">
                            <tr class="warning">
                                ...
                                $sel_message = "SELECT * FROM messages where receiver='$user_id' ";
                       ...
                       <a href="home.php">
                       <button class="btn btn-primary navbar-right">Back to Home Page</button></a>
                    </div>
                </div>
           </div>
           </div>
