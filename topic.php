           ...
           <div class="row " >
               ...
               <div class="col-md-12" style="margin-top:10px;background-color:white; ">
                   ...
                   <div class="container-fluid" style="margin-left:-15px;">
                        ...
                        if(isset($_GET['topic'])){
                            ...
                            $get_posts = "SELECT * FROM posts WHERE topic_id = '$topic_id' ORDER BY post_id DESC LIMIT $start_from, $record_per_page";
               ...
               <div class="col-md-12 text-center">
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                          <?php 
                            $page_query = "select * from posts WHERE topic_id = '$topic_id' ";
                            $page_result = mysqli_query($con,$page_query);
                            $total_records = mysqli_num_rows($page_result);
                            $total_pages = ceil($total_records/$record_per_page);
                            for ($i=1;$i<=$total_pages; $i++)
                            {
                                echo "<li><a href='topic.php?topic=$topic_id&page=".$i."'>".$i."</a></li>";
                            }
                            ?>
                      </ul>
                    </nav>
